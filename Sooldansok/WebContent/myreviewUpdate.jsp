...
<body>
	...
	<div class=my_wrapper>
		...
		<form action="ReviewUpdate.review" method="post" id="reviewinsertsubmit">
			<table class="review_insertboard">
				...
				<tr>
					<td  style="width:60vw;"><textarea name="reviewcontent" id="idtextarea" 
						class="rv_tarea" placeholder="내용을 입력하세요">${rv.comments}</textarea></td>
				</tr>
				<tr>
			...
			<input type="submit" class="rv_insert_btn" value="수정완료" onclick="reviewinsertconfirm();">
			<input type="hidden" name="rev_num" value="${rv.rev_num}">
			</div>
	...
	<script type="text/javascript">
        function reviewinsertconfirm() {
            var result = confirm("리뷰를 수정하시겠습니까? 별점을 다시한번 확인해주세요.");
            if (result == true) {
