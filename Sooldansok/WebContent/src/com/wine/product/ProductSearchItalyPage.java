...
public class ProductSearchItalyPage implements PageTelImpl {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		int totalcount = pddao.getSearchItalyCount(search);
		...
		int page2 = page + 7;
		ArrayList<Pd_InfoVO> itArr = pddao.getSearchItaly(page, page2, search);
