...
public class ProductSearchAllPage implements PageTelImpl {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		int totalcount = pddao.getSearchTotalCount(search);
		...
		int page2 = page + 7;
		ArrayList<Pd_InfoVO> pdArr = pddao.getSearchAll(page, page2, search);

		request.setAttribute("productsum", totalcount);
		request.setAttribute("pdArr", pdArr);
