...
public class ProductSearchChilePage implements PageTelImpl {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		int totalcount = pddao.getSearchChileCount(search);
		...
		int page2 = page + 7;
		ArrayList<Pd_InfoVO> chArr = pddao.getSearchChile(page, page2, search);

		request.setAttribute("productsum", totalcount);
		request.setAttribute("chArr", chArr);
