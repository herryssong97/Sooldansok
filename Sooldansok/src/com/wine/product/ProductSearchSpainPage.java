...
public class ProductSearchSpainPage implements PageTelImpl {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		int totalcount = pddao.getSearchSpainCount(search);
		...
		int page2 = page + 7;
		ArrayList<Pd_InfoVO> spArr = pddao.getSearchSpain(page, page2, search);

		request.setAttribute("productsum", totalcount);
		request.setAttribute("spArr", spArr);
